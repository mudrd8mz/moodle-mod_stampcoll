 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class stamp_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstampadded', 'mod_stampcoll');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' gave stamp with id '$this->objectid' to the user with id '$this->relateduserid' ".
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'stampcoll', 'add stamp', 'view.php?id='.$this->contextinstanceid,
