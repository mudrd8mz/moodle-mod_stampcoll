 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class stamp_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstampupdated', 'mod_stampcoll');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'stampcoll', 'update stamp', 'view.php?id='.$this->contextinstanceid,
