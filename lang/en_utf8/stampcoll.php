...
$string['nostamps'] = 'No stamps';
$string['nostampsyet'] = 'No stamps have been collected yet';
$string['notallowedtoviewstamps'] = 'You are not allowed to view stamps in this collection';
$string['nousers'] = 'No users';
$string['numberofcollectedstamps'] = 'Number of collected stamps';
$string['numberofstamps'] = 'Count';
$string['numberofyourstamps'] = 'Number of your stamps: $a';
$string['ownstamps'] = 'Own stamps';
$string['publishall'] = 'Students can see everyone\'s stamps';
$string['publishnone'] = 'Stamps are hidden';
$string['publish'] = 'Publish';
$string['publishselfonly'] = 'Students can only see their own stamps';
$string['showupdateforms'] = 'Show forms to update stamps';
$string['stampcoll:collectstamps'] = 'Collect stamps';
$string['stampcoll:deletestamps'] = 'Delete stamps';
...
$string['stampsarenotpublic'] = 'Stamps are currently hidden';
$string['studentsperpage'] = 'Students per page';
$string['teachercancollect'] = 'Teacher can collect stamps';
