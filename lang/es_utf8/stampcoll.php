...
$string['modulenameplural'] = 'Colección de sellos';
...
$string['notallowedtoviewstamps'] = 'No estás autorizado para ver sellos en esta colección';
$string['nousers'] = 'No hay usuarios';
$string['numberofcollectedstamps'] = 'Sellos coleccionados: $a';
$string['numberofstamps'] = 'Sellos';
$string['numberofyourstamps'] = 'Número de sellos: $a';
...
$string['stampimageinfo'] = 'Tamaño recomendado 35x35 pixels';
$string['stampimage'] = 'Imagen del sello';
$string['studentsperpage'] = 'Alumnos por página';
