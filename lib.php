 ...
 * Display self stamps?
 */
define('STAMPCOLL_DISPLAY_NONE',    '0');

/**
 * Display self stamps only?
 */
define('STAMPCOLL_DISPLAY_OWN',    '1');

/**
 * Display all stamps?
 */
define('STAMPCOLL_DISPLAY_ALL',         '2');

$STAMPCOLL_DISPLAY = array (STAMPCOLL_DISPLAY_NONE      => get_string('displaynone', 'stampcoll'),
                            STAMPCOLL_DISPLAY_OWN  => get_string('displayown', 'stampcoll'),
                            STAMPCOLL_DISPLAY_ALL       => get_string('displayall', 'stampcoll'));
...
function stampcoll_user_complete($course, $user, $mod, $stampcoll) {
    if (!$allstamps = stampcoll_get_stamps($stampcoll->id)) {
        ...
        if ($stampcoll->publish == STAMPCOLL_DISPLAY_NONE) {
    ...
    if ((isteacher($course->id)) || ($stampcoll->publish <> STAMPCOLL_DISPLAY_NONE)) {
