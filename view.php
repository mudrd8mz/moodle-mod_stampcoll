<?php  // $Id$
    ...
    if ((!isteacher($course->id)) && ($stampcoll->publish == STAMPCOLL_DISPLAY_OWN)) {
    ...
    if ((isteacher($course->id)) || ($stampcoll->publish == STAMPCOLL_DISPLAY_ALL)) {
    ...
    /// Construct the SQL
        ...
        echo '<label for="perpage">'.get_string('usersperpage','stampcoll').'</label>';
        echo ':</td>';
        echo '<td align="left">';
